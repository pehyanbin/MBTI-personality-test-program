...
int main() {
    ...
    cout << "------------------------------------------------------------------------------------------------------" << "\n";
    cout << "Are you a person who prefers facts and details and focus on present or\n"
        << "a person who likes abstract theories and ideas and like to imagine things and future possiblities ?" << "\n"
    ...
    cout << "------------------------------------------------------------------------------------------------------" << "\n";
    cout << "How do you make decisions ?\nDo you make decisions based on the logical and consistency of the choice or\n"
        << "taking into consideration of the perspective of everyone involved in ?" << "\n"
        << "\"Type 1 for the first option and 0 for the second option.\"" << "\n";
    bool tf;
    cin >> tf;
    ...
    cout << "------------------------------------------------------------------------------------------------------" << "\n";
    cout << "How you relate to the outside world?" << "\n" << "Do you tend to be decision-oriented and organized,\n"
        << "who who make to-do lists and enjoy getting things done ahead of deadlines"
        << "or more hesitant to make decisions, liking to leave things open and keep making observations and will tend to procrastinate tasks ?\n"
        << "\"Type 1 for the first option and 0 for the second option.\"" << "\n";
    bool jp;
    cin >> jp;
